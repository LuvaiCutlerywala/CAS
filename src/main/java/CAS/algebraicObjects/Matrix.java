...
public class Matrix {
    ...
    /**
     * Returns the value of the matrix element at the index specified.
     *
    ...
    public double getMatrixElement(Tuple<Integer, Integer> index){
        if(index.getA() > dim.getA() || index.getB() > dim.getB()) {
    ...
    /**
     * Sets the value of the matrix element at the index specified to the value provided.
     *
     * @param index The index of the element.
